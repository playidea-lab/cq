...
# Cstem Project - AI Agent Instructions

> **Cstem** = System의 발음 변형. C1·C2·C3·C4·C5·C9가 유기적으로 연결된 생태계를 의미한다.  
> 이 리포지토리는 C4 Engine을 포함하며, C4: AI 오케스트레이션 — 계획부터 완료까지 자동화된 프로젝트 관리.
