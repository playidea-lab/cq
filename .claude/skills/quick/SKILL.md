...
작업 완료 후에는 `/submit`으로 제출하세요.

## Usage

```
/quick "작업 설명"
/quick "버그 수정: connection timeout" scope=c4/daemon/
```
...
```
/quick "버그 수정: health check timeout"
