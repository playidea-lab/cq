...
//   - Set supabase.direct_url in config or C5_SUPABASE_DIRECT_URL env var.
package hub
...
const (
	...
	// reconnectMaxAttempts limits retry loops (0 = unlimited).
...
// backoff returns the exponential delay for the given attempt number (1-based).
