...
| Skill | Triggers | Description |
|-------|----------|-------------|
| `/c4-polish` | polish | Continuous build-test-review-fix loop until reviewer finds zero changes. Coding equivalent of "done done". |
| `/c4-refine` | refine | Iterative review-fix loop using isolated worker context. Spawns fresh reviewer each round. |
